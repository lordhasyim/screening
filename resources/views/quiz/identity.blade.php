...
.form-control-pastel, .form-select-pastel {
    border: 1px solid #e1e8ed;
    border-radius: 8px;
    transition: all 0.3s ease;
}

.form-control-pastel:focus, .form-select-pastel:focus {
    border-color: #4e73df;
    box-shadow: 0 0 0 0.2rem rgba(78, 115, 223, 0.25);
}

.is-invalid .form-control-pastel, .is-invalid .form-select-pastel {
    border-color: #e74a3b;
}
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <h6 class="alert-heading"><i class="bi bi-exclamation-triangle me-2"></i>Ada kesalahan dalam pengisian form:</h6>
                <ul class="mb-0">
                    ...
                    <form id="identityForm" method="POST" action="{{ route('quiz.identity') }}" novalidate>
                        ...
                        <div class="form-section">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <select id="student_year" name="student_year" class="form-select form-select-pastel @error('student_year') is-invalid @enderror" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="faculty_id" name="faculty_id" class="form-select form-select-pastel @error('faculty_id') is-invalid @enderror" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="department_id" name="department_id" class="form-select form-select-pastel @error('department_id') is-invalid @enderror" required disabled>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="nim" name="nim" class="form-control form-control-pastel @error('nim') is-invalid @enderror" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="full_name" name="full_name" class="form-control form-control-pastel @error('full_name') is-invalid @enderror" 
                        ...
                        <div class="form-section">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <select id="gender" name="gender" class="form-select form-select-pastel @error('gender') is-invalid @enderror" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="origin_province_id" name="origin_province_id" class="form-select form-select-pastel @error('origin_province_id') is-invalid @enderror" required>
                                        <option value="">Pilih Provinsi</option>
                                        @foreach($provinces as $province)
                                            <option value="{{ $province->id }}" {{ old('origin_province_id') == $province->id ? 'selected' : '' }}>
                                                {{ $province->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="origin_city_id" name="origin_city_id" class="form-select form-select-pastel select2-city @error('origin_city_id') is-invalid @enderror" required disabled>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="birth_place" name="birth_place" class="form-control form-control-pastel @error('birth_place') is-invalid @enderror" 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" id="birth_date" name="birth_date" class="form-control form-control-pastel @error('birth_date') is-invalid @enderror" 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="tel" id="phone" name="phone" class="form-control form-control-pastel @error('phone') is-invalid @enderror" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" id="email" name="email" class="form-control form-control-pastel @error('email') is-invalid @enderror" 
                                           value="{{ old('email') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="religion" name="religion" class="form-select form-select-pastel @error('religion') is-invalid @enderror" required>
                                        <option value="">Pilih</option>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea id="address" name="address" class="form-control form-control-pastel @error('address') is-invalid @enderror" rows="3" required
                        ...
                        <div class="form-section">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <select id="living_arrangement" name="living_arrangement" class="form-select form-select-pastel @error('living_arrangement') is-invalid @enderror" required>
                                        <option value="">Pilih</option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="origin_area_type" name="origin_area_type" class="form-select form-select-pastel @error('origin_area_type') is-invalid @enderror" required>
                                        <option value="">Pilih</option>
                        ...
                        <div class="form-section">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <select id="parents_marital_status" name="parents_marital_status" class="form-select form-select-pastel @error('parents_marital_status') is-invalid @enderror" required>
                                        <option value="">Pilih</option>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" id="child_order" name="child_order" class="form-control form-control-pastel @error('child_order') is-invalid @enderror" 
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" id="siblings_count" name="siblings_count" class="form-control form-control-pastel @error('siblings_count') is-invalid @enderror" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="scholarship" name="scholarship" class="form-control form-control-pastel @error('scholarship') is-invalid @enderror" 
                                           value="{{ old('scholarship') }}"
                                           placeholder="KIP, Beasiswa Prestasi, dll">
                                    @error('scholarship')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="admission_path" name="admission_path" class="form-select form-select-pastel @error('admission_path') is-invalid @enderror" required>
                                        <option value="">Pilih</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="parents_education" name="parents_education" class="form-select form-select-pastel @error('parents_education') is-invalid @enderror" required>
                                        <option value="">Pilih</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="parents_income" name="parents_income" class="form-select form-select-pastel @error('parents_income') is-invalid @enderror" required>
                                        <option value="">Pilih</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" id="family_members_count" name="family_members_count" class="form-control form-control-pastel @error('family_members_count') is-invalid @enderror" 
                        ...
                        <div class="form-section">
                            <h5 class="mb-4 text-primary">
                                ...
                                Riwayat Kesehatan
                                <button type="button" class="btn btn-sm btn-outline-secondary ms-2" data-bs-toggle="collapse" data-bs-target="#medicalHistory" aria-expanded="false">
                            ...
                            <div id="medicalHistory" class="collapse">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="substance_use" name="substance_use" class="form-select form-select-pastel @error('substance_use') is-invalid @enderror">
                                            <option value="Tidak Pernah" {{ old('substance_use', 'Tidak Pernah') == 'Tidak Pernah' ? 'selected' : '' }}>Tidak Pernah</option>
                            ...
                            <div class="d-flex align-items-center">
                                <div id="form-progress" class="me-3" style="display: none;">
                                    <small class="text-muted">
                                        <span id="filled-fields">0</span> dari <span id="total-fields">0</span> field terisi
                                    </small>
                                </div>
...
$(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(departments) {
                    ...
                    if (departments && departments.length > 0) {
                        ...
                        $departmentSelect.html('<option value="">Tidak ada jurusan tersedia</option>');
                        showNotification('Tidak ada jurusan tersedia untuk fakultas ini', 'warning');
                    }
                },
                error: function(xhr, status, error) {
                    $loading.hide();
                    $departmentSelect.html('<option value="">Error memuat data</option>');
                ...
                success: function(cities) {
                    ...
                    if (cities && cities.length > 0) {
                        ...
                        cities.forEach(function(city) {
                            const selected = "{{ old('origin_city_id') }}" == city.id ? 'selected' : '';
                        ...
                        $citySelect.html('<option value="">Tidak ada kota/kabupaten tersedia</option>');
                        $citySelect.select2('destroy').select2({
                            theme: 'bootstrap-5',
    ...
    $('#origin_city_id').on('change', function() {
        ...
        if (selectedCityText && selectedCityText !== 'Pilih Kota/Kabupaten' && selectedCityText !== 'Pilih Provinsi dulu') {
            if (!$('#birth_place').val()) {
                    ...
                    formData.forEach(function(field) {
                        ...
                        if ($field.length) {
                            if ($field.is(':checkbox') || $field.is(':radio')) {
                                $field.prop('checked', field.value == '1' || field.value == $field.val());
                            } else {
...
function validateForm() {
    ...
    $('#total-fields').text(requiredFields.length);
